            ...
            <div class="col-lg-12">
                <table cellpadding="10">
                    <tr>
                        ...
                        <td><form action="mostrarClient.php" method="get"><input type="hidden" name="mode" value="0">
						 <button style="margin-top: 5px; margin-left: 15px" type='submit' class="btn btn-primary "><i class="fa fa-user-plus"></i> Afegir un client</button></form></td>
                    </tr>
                </table>
            </div>
            <!-- /.col-lg-12 -->

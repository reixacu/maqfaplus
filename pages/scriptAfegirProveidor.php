...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Procés afegir Proveidor</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            $diaMensualPagament2 = $_POST["diaMensualPagament2"];
                        ...
                        switch(checkEsEmpresa($nom, $raoSocial))
                        {
                            case -1:
                                ...
                                break;
                            case 0:
                                $sql = "INSERT INTO `proveidors` (`id_client`, `nif_client`, `nom_client`, `cognom_client`,
                        ...
                        if (!$errorComprovarEsEmpresa)
                        {
                            ...
                            <div class=\"col-lg-12\">
                                <table style='margin-top: 20px;'>
                                    <tr>
                                        <td><form action=\"mostrarProveidor.php\" method=\"get\"><input type=\"hidden\" name=\"mode\" value=\"0\"><button type='submit' class=\"btn btn-primary\">Afegir un altre proveidor</button></form></td>
                                        <td><form action=\"mostrarProveidor.php\" method=\"get\"><input type=\"hidden\" name=\"mode\" value=\"1\"><input type=\"hidden\" name=\"id\" value=\"" . getProveidorIdFromNIF($nif) . "\"><button style='margin: 5px;' type='submit' class=\"btn btn-info\"><i class=\"fa fa-pencil\"></i> Editar proveidor</button></form></td>
                                    </tr>
                                </table>
                                <br />

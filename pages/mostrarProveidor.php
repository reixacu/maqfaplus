...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <table style='margin-top: 20px;'>
                    <tr>
                        <td><form type='submit' action='proveidors.php'>
                          ...
                          <?php
                            if($mode==2)
                            echo '<td><form action="mostrarProveidor.php" method="get">
                              <input type="hidden" name="mode" value="1">
                              <input type="hidden" name="id" value="'.$id.'">
                              <button style="margin: 5px;" type="submit" class="btn btn-info">
                                <i class="fa fa-pencil"></i>
                                Editar proveidor</button>
                              </form></td>';
                          ?>
                    </tr>
                </table>
        ...
        <div class="row">
            <div class="col-lg-12">
                <?php
                  if($mode==0) echo '<h1 class="page-header"><i class="fa fa-user-plus"></i> Afegir un nou proveidor</h1>';
                  elseif($mode==1) echo '<h1 class="page-header"><i class="fa fa-pencil"></i> Modificar proveidor</h1>';
                  else echo '<h1 class="page-header"><i class="fa fa-industry"></i> Mostrar proveidor</h1>';
                 ?>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <?php
                          if($mode==0) echo 'Formulari afegir proveidor';
                          elseif($mode==1) echo 'Formulari modificar proveidor';
                          else echo 'Dades proveidor';
                        ?>
                    </div>
                    <div class="panel-body">
                      <?php
                        if($mode==0) echo '<form role="form" action="scriptAfegirProveidor.php" method="post">';
                        elseif($mode==1) echo '<form role="form" action="scriptEditarProveidor.php" method="post">';
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label>Número de proveidor</label>
                                        <?php
                        ...
                        <?php mostrarcamp($mode,"IBAN",$mode!=0?$row["numero_conta_client"]:"","IBAN");?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <?php
                                      if($mode==0){
                                        echo '<button type="submit" class="btn btn-primary">Crear el proveidor</button>';
                                        echo '<button type="reset" class="btn btn-warning btn-outline">Netejar els camps</button>';
                                      }
                                      elseif($mode==1){
                                        echo '<input type="hidden" name="id" value="'.$id.'">';
                                        echo '<button type="submit" class="btn btn-primary">Modificar dades proevidor</button>';
                                        echo '<button type="reset" class="btn btn-warning btn-outline">Netejar els camps</button>';
                                      }

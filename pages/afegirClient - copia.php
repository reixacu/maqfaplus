...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><i class="fa fa-user-plus"></i> Afegir un nou client</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="panel-body">
										...
										<div class="form-group">
                                            ...
                                            <input name="formaPagament" class="form-control" placeholder="Dia preferit del client per als pagaments">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.col-lg-6 (nested) -->

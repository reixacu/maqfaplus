...
$resultDadesFactura = getLiniesPressupostData($idFactura);
...
$quantitatElements = getNumRowsDetallsPressupost($idFactura);
...
$pdf->SetAuthor('MAQFA');
$pdf->SetTitle('PressupostPDF');
$pdf->SetSubject('PressupostPDF');
$pdf->SetKeywords('PDF');
...
<table style="width:100%;" border="1">
	<tr>
		<td colspan="2" style="text-align:center;background-color:#DDDDDD;"><b>PRESSUPOST Nº </b></td>
...
$html = '
		<table border="1">
			<tr>
				...
				<td style="text-align:center;background-color:#DDDDDD;"><b> TOTAL PRESSUPOST </b></td>
			</tr>
			<tr>
...
$pdf->Output( '/home/pi/factures/pressupost_' . $idFactura . '.pdf', 'F');

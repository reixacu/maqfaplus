                    ...
                    <table style='margin-top: 20px;'>
                        <tr>
                            ...
                            ";
                             ...
                             {
                               echo "<td><form action='enviarMailFactura.php' method='get'><input type=\"hidden\" name=\"id\" value=\"" . $id . "\"><button style='margin: 5px;' type='submit' class=\"btn btn-success\"><i class=\"fa fa-envelope \"></i> <i class=\"fa fa-check-circle\"></i> Tornar a enviar</button></form>";
                             }
                             else {
